...
//hata aqui copiar
        ...
        private void InicioAdmin_Load(object sender, EventArgs e)
        {
           ...
           // btnRegistrarC.Region = Region.FromHrgn(CreateRoundRectRgn(0,0,btnRegistrarC.Width, btnRegistrarC.Height,30,30));
            ...
            IntPtr region9 = CreateRoundRectRgn(0, 0, button1.Width, button1.Height, 30, 30);
            SetWindowRgn(button1.Handle, region9, true);

            IntPtr region10 = CreateRoundRectRgn(0, 0, btnBuscar.Width, btnBuscar.Height, 30, 30);
            SetWindowRgn(btnBuscar.Handle, region10, true);


            IntPtr region11 = CreateRoundRectRgn(0, 0, button2.Width, button2.Height, 30, 30);
            SetWindowRgn(button2.Handle, region11, true);


            IntPtr region12 = CreateRoundRectRgn(0, 0, btnClienteB.Width, btnClienteB.Height, 30, 30);
            SetWindowRgn(btnClienteB.Handle, region12, true);


            IntPtr region13 = CreateRoundRectRgn(0, 0, btnEE.Width, btnEE.Height, 30, 30);
            SetWindowRgn(btnEE.Handle, region13, true);


            IntPtr region14 = CreateRoundRectRgn(0, 0, btnAsigTecnico.Width, btnAsigTecnico.Height, 30, 30);
            SetWindowRgn(btnAsigTecnico.Handle, region14, true);
